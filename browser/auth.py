...
class WBAuthService:
    ...
    async def refresh_profiles_with_cookies(self, cookies: list) -> list:
        """
        Перепарсить профили из WB используя существующие cookies.

        Args:
            cookies: Список cookies из browser_session
